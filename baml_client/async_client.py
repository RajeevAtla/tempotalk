...
class BamlAsyncClient:
    ...
    async def GenerateMeetingScript(self, provider_id: str,tumor_focus: str,kb_context: str,
    ...
    async def GenerateObjectionHandler(self, provider_id: str,concern: str,kb_context: str,
        baml_options: BamlCallOptions = {},
